...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* La página de favoritos requiere sesión (verificada en el servidor):
     si no hay usuario se redirige a login con vuelta a esta página. */
  if (typeof window.requireSesionPage === 'function' && !window.requireSesionPage()) {
    return;
  }
