...
function actualizarResumen(carrito) {
  ...
  var grupo = typeof grupoElegido === 'function' ? grupoElegido() : 'todo';
  var incluyeProd = grupo === 'todo' || grupo === 'productos';
  var incluyeServ = grupo === 'todo' || grupo === 'servicios';
...
function alternarGrupo() {
  ...
  if (bloque.hidden) {
    var todo = document.querySelector('input[name="pago_grupo"][value="todo"]');
